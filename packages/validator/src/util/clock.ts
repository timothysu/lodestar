...
export class Clock implements IClock {
  ...
  constructor(config: ChainForkConfig, logger: ILogger, opts: {genesisTime: number}) {
 ...
 */
export function getCurrentSlotAround(config: ChainForkConfig, genesisTime: Number64): Slot {
