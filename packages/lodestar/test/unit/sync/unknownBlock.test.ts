...
describe("sync / UnknownBlockSync", () => {
  ...
  it("fetch and process multiple unknown block parents", async () => {
    ...
    const blockA = ssz.phase0.SignedBeaconBlock.defaultTreeBacked();
    const blockB = ssz.phase0.SignedBeaconBlock.defaultTreeBacked();
    const blockC = ssz.phase0.SignedBeaconBlock.defaultTreeBacked();
